(function(a){var r,P,H,q;window.$mg_sel_grid=!1;var t={},v={},C=!1,y=!1;window.mg_lb_video_h_ratio=.55;var J={},K={},D={},I={},da={};window.mg_grid_filters={};var Q={},R={};window.mg_slider_autoplay={};var w={},S={},E={},L=!1,n=!1,T="",U="",V="",M=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?!0:!1;a(document).ready(function(b){ea();fa(!0)});window.mg_init_grid=function(b,c){if(!a("#"+b).length)return!1;a("#"+b).data("grid-id");J[b]=!1;a("#mg_lb_wrap").length||
ea();D[b]=c;ha(b)};window.mg_async_init=function(b,c){mg_init_grid(b,c)};var ha=function(b){W(b,!0);F(b);lcmg.show_filter_match&&mg_matches_per_filter(b);X(b);a(window).trigger("mg_pre_grid_init",[b]);setTimeout(function(){ia(b,!0);a("#"+b+" .mg_items_container").length&&(t[b]=new Muuri(a("#"+b+" .mg_items_container")[0],{items:a("#"+b+" .mg_items_container")[0].getElementsByClassName("mg_box"),containerClass:"mg-muuri",itemClass:"mg-muuri-item",itemVisibleClass:"mg-muuri-shown",itemHiddenClass:"mg-muuri-hidden",
layoutOnResize:!1,layout:{fillGaps:!0,alignRight:lcmg.rtl,rounding:!1},layoutDuration:450,layoutEasing:"ease-out",showDuration:450,showEasing:"ease-out",hideDuration:450,hideEasing:"ease-out",visibleStyles:{opacity:"1",transform:"scale(1)"},hiddenStyles:{opacity:"0",transform:"scale(0.5)"}}),a("#"+b).addClass("mg_muurified"),mg_exec_filters(b,!0))},60)},W=function(b,c){var d="undefined"==typeof b?a(".mg_items_container"):a("#"+b+" .mg_items_container");if(!d.length)return!1;if(1==d.length)if(d.outerWidth()&&
0!==d.outerWidth()%2)d.toggleClass("mg_not_even_w"),"undefined"==typeof c&&N(b);else return!0;else d.each(function(){W(a(this).parents(".mg_grid_wrap").attr("id"))})},X=function(b,c,d){var e=a("#"+b),f=a("#"+b+".mg_muurified").length?!1:!0,g="object"!=typeof c?!1:!0,h=f||g?!1:!0,k="undefined"==typeof lcmg.mobile_thold?800:lcmg.mobile_thold;"undefined"!=typeof a("#"+b).attr("data-mobile-treshold")&&(k=parseInt(a("#"+b).data("mobile-treshold"),10));c=g?c.find(".mgi_main_thumb"):a("#"+b+" .mg_box").not(".mg_pag_hide, .mg_cat_hide, .mg_search_hide").find(".mgi_main_thumb");
var l=a("#"+b).parent().width();if(!l)return!1;"undefined"==typeof v[b]&&(v[b]=!1);if(l<k&&(!v[b]||f||g||d))return c.each(function(){a(this).css("background-image","url('"+a(this).data("mobileurl")+"')")}),v[b]=!0,e.addClass("mg_mobile_mode"),h&&a(window).trigger("mg_mobile_mode_switch",[b]),!0;if(l>=k&&(v[b]||f||g||d))return c.each(function(){a(this).css("background-image","url('"+a(this).data("fullurl")+"')")}),v[b]=!1,e.removeClass("mg_mobile_mode"),h&&a(window).trigger("mg_mobile_mode_switch",
[b]),!0},ia=function(b,c){a("#"+b+" .mg_grid_title_under .mg_has_txt_under").each(function(){var d=a(this),e=d.attr("id"),f="undefined"==typeof Q[e]?!1:Q[e],g=d.find(".mgi_txt_under").outerHeight(!0);if(!1===f||f!=g)Q[e]=g,d.css("margin-bottom",g)});"undefined"!=typeof c&&N(b)},xa=function(b){a("#"+b+" .mg_items_container").stop().fadeTo(300,1);a("#"+b).find(".mg_loader").stop().fadeOut(300)},ya=function(b){a("#"+b+" .mg_items_container").stop().fadeTo(300,.25);a("#"+b).find(".mg_loader").stop().fadeIn(300)},
N=function(b){"undefined"==typeof b?a(".mg_muurified").each(function(){N(a(this).attr("id"))}):"undefined"!=typeof t[b]&&(t[b].refreshItems(),t[b].layout(!0))};a(document).ready(function(){setInterval(function(){a(".mg_grid_wrap").each(function(){var b=a(this).attr("id"),c=Math.round(a(this).width());if("undefined"==typeof K[b])return K[b]=c,!0;K[b]!=c&&(K[b]=c)&&a(window).trigger("mg_resize_grid",[b])})},210)});a(window).on("mg_resize_grid",function(b,c){a("#"+c+".mg_muurified").length?(N(c),X(c,
!1,!0),W(c),F(c),F(c,!0),ia(c),ja(c)):ha(c)});var ka=function(b,c,d){ja(b);a("#"+b+".mg_no_results").removeClass("mg_no_results");if(c.not(".mgi_ready, .mg_inl_slider, .mg_inl_text").find(".mgi_main_thumb").length){a("#"+b+" .mg_loader").is(":hidden")&&ya(b);var e=a("<div></div>");c.not(".mgi_ready").find(".mgi_main_thumb").each(function(){var f=v[b]?a(this).attr("data-mobileurl"):a(this).attr("data-fullurl");e.append('<img src="'+f+'" />')});lc_lazyload(e.find("img"),{allLoaded:function(f){c.mg_display_boxes(b);
"function"==typeof d&&d.call()}})}else c.mg_display_boxes(b),"function"==typeof d&&d.call()};a.fn.mg_display_boxes=function(b){var c=J[b]?!0:!1;xa(b);var d=0,e=lcmg.delayed_fx&&!J[b]?170:0,f=this.length*e;this.each(function(g,h){var k=a(this),l=e*d;k.addClass("mgi_ready");setTimeout(function(){k.addClass("mgi_shown");k.hasClass("mg_to_kenburn")&&k.find(".mgi_main_thumb").mg_kenburns();if(k.hasClass("mg_inl_slider")){var m=k.find(".mg_inl_slider_wrap").attr("id");za(m)}k.find(".mg_self-hosted-video").length&&
(m="#"+k.find(".mg_sh_inl_video").attr("id"),mg_video_player(m,!0));!k.hasClass("mg_inl_video")||k.find(".mg_sh_inl_video").length||-1==navigator.userAgent.indexOf("Chrome/")&&-1==navigator.appVersion.indexOf("Safari/")||setTimeout(function(){k.find(".mg_shadow_div").css("transform","none").css("animation","none").css("-webkit-transform","none").css("-webkit-animation","none").css("opacity",1)},350);k.hasClass("mg_inl_audio")&&k.find(".mg_inl_audio_player").length&&setTimeout(function(){var p="#"+
k.find(".mg_inl_audio_player").attr("id");la(p)},350);k.find(".mg_inl_txt_video_bg").length&&(m=k.find(".mg_inl_txt_video_bg")[0],m.currentTime=0,m.play())},l);d++});setTimeout(function(){c||(J[b]=!0,a("#"+b+" .mg_no_init_loader").removeClass("mg_no_init_loader"),a("#"+b).addClass("mgi_shown"),a(window).trigger("mg_grid_shown",[b]));Aa(b)},f);a(window).trigger("mg_items_ready",[b,this,c]);return!0};window.mg_exec_filters=function(b,c){var d=a("#"+b),e=parseInt(d.data("filtered-per-page"),10);if("object"!=
typeof mg_grid_filters[b]||d.hasClass("mg_is_filtering"))return!1;var f=mg_grid_filters[b];d.addClass("mg_is_filtering");d.find(".mg_no_results").removeClass("mg_no_results");d.find(".mg_box").removeClass("mg_filtered mg_hidden_pag");var g=a("#"+b+" .mg_box"),h=g;if(!lcmg.monopage_filter&&1<Object.keys(f).length&&"undefined"!=typeof f.mg_pag_){d.find(".mg_pag_wrap").fadeOut(400);var k=!0}else d.find(".mg_pag_wrap").fadeIn(400),k=!1;var l="standard";"standard"==lcmg.filters_behav||d.find(".mg_pag_wrap").length&&
!lcmg.monopage_filter||(l=lcmg.filters_behav);var m=Object.keys(mg_grid_filters[b]);a.each(m,function(u,G){var x=mg_grid_filters[b][G];if("object"!=typeof x.val||!x.val.length||"undefined"==typeof x.condition||k&&"mg_pag_"==G)return!0;if("AND"==x.condition){var z="";a.each(x.val,function(Ba,Y){z+="."+G+Y})}else z=[],a.each(x.val,function(Ba,Y){z.push("."+G+Y)}),z=z.join(" , ");h=h.filter(z);"mg_pag_"==G&&g.not(z).addClass("mg_hidden_pag")});h.addClass("mg_filtered");f="standard"==l?h:g.not(".mg_hidden_pag");
var p="standard"==l?".mg_filtered":"*:not(.mg_hidden_pag)";X(b,f);"standard"!=l&&(l="0_opacity"==l?0:.4,g.not(".mg_filtered").addClass("mgi_low_opacity_f").fadeTo(450,l),h.removeClass("mgi_low_opacity_f").fadeTo(450,1));"undefined"!=typeof c?(d.find(".mg_items_container").removeClass("mgic_pre_show"),ka(b,f),t[b].filter(p),ma(b),d.removeClass("mg_is_filtering"),na(b,d,m,e,p)):(ka(b,f,function(){"undefined"!=typeof t[b]&&(t[b].filter(p),ma(b),d.removeClass("mg_is_filtering"),a(window).trigger("mg_filtered_grid",
[b]),na(b,d,m,e,p))}),mg_pause_inl_players(b))};var na=function(b,c,d,e,f){var g=c.find(".mg_box.mg_filtered"),h=c.find(".mg_fpp_pag_wrap");if(!h.length)return!0;"undefined"==typeof I[b]&&(I[b]=1,da[b]=h.html());g.removeClass("mg_fpp_hidden");I[b]=1;h.attr("data-init-pag",1);if(e&&g.length>e&&(-1===a.inArray("mg_pag_",d)&&d.length||-1!==a.inArray("mg_pag_",d)&&1<d.length)){d=Math.ceil(g.length/e);h.attr("data-tot-pag",d);h.find(".mg_fpp_tot_pag").text(d);if(h.find(".mg_fpp_pag_btn").length){h.html(da[b]);
c=h.find(".mg_fpp_pag_btn")[0].outerHTML.replace("mg_sel_pag","");for(e=1;e<d;e++)h.append(c.replace(/[1]/g,e+1));F(b,!0)}else h.find(".mg_fpp_curr_pag").text(1),h.find(".mg_prev_page").addClass("mg_pag_disabled"),h.find(".mg_next_page").removeClass("mg_pag_disabled"),h.hasClass("mg_inf_scroll")&&(c[0].style.paddingBottom="");g.slice(2).addClass("mg_fpp_hidden");t[b].filter(f+":not(.mg_fpp_hidden)");h.fadeIn(200)}else c.find(".mg_fpp_pag_wrap").hide(),t[b].filter(f)},ma=function(b){a("#"+b+" .mg-muuri-shown").length?
a("#"+b+" .mg_items_container").removeClass("mg_no_results"):a("#"+b+" .mg_items_container").addClass("mg_no_results")};a(document).on("click",".mg_mobile_mode .mg_dd_mobile_filters .mgf_inner",function(b){q=!0;b.preventDefault();b.stopImmediatePropagation();var c=a(this);"undefined"!=typeof mg_dd_toggle_timeout&&clearTimeout(mg_dd_toggle_timeout);mg_dd_toggle_timeout=setTimeout(function(){c.toggleClass("mgf_dd_expanded")},50)});a(document).ready(function(){a(document).on("click",".mg_next_page:not(.mg_pag_disabled), .mg_prev_page:not(.mg_pag_disabled)",
function(){q=!0;var b=a(this).hasClass("mg_next_page")?"next":"prev";a(this).parents(".mg_fpp_pag_wrap").length?oa(b,a(this).parents(".mg_grid_wrap").attr("id")):pa(b,a(this).parents(".mg_grid_wrap").attr("id"))});a(document).on("click",".mg_pag_btn_nums > div:not(.mg_sel_pag), .mg_pag_btn_dots > div:not(.mg_sel_pag)",function(){q=!0;var b=a(this).data("pag"),c=a(this).parents(".mg_grid_wrap").attr("id");a(this).parents(".mg_pag_wrap").find("> div").removeClass("mg_sel_pag");a(this).addClass("mg_sel_pag");
a(this).parents(".mg_fpp_pag_wrap").length?(F(c,!0),oa(b,c)):(F(c),pa(b,c))})});var pa=function(b,c){var d=a("#"+c).data("grid-id"),e=parseInt(a("#mgp_"+c).data("tot-pag"),10),f=parseInt(D[c],10);if(-1!==a.inArray(b,["next","prev"])){if("next"==b&&f>=e||"prev"==b&&1>=f)return!1;var g="next"==b?f+1:f-1}else if(g=parseInt(b),1>g||g>e||g==f)return!1;D[c]=g;1==g?mg_remove_deeplink("page","mgp_"+d):mg_set_deeplink("page","mgp_"+d,g);1==g?a("#mgp_"+c+" .mg_prev_page").addClass("mg_pag_disabled"):a("#mgp_"+
c+" .mg_prev_page").removeClass("mg_pag_disabled");g==e?a("#mgp_"+c+" .mg_next_page").addClass("mg_pag_disabled"):a("#mgp_"+c+" .mg_next_page").removeClass("mg_pag_disabled");a("#mgp_"+c+" .mg_nav_mid span").length&&a("#mgp_"+c+" .mg_nav_mid span").text(g);mg_grid_filters[c].mg_pag_={condition:"AND",val:[g]};mg_exec_filters(c);a(window).trigger("mg_resize_grid",[c]);lcmg.scrolltop_on_pag&&a("html, body").animate({scrollTop:a("#"+c).offset().top-15},300)},oa=function(b,c){if(a("#"+c).hasClass("mg_is_filtering"))return!1;
var d=a("#"+c);d.data("grid-id");var e=d.find(".mg_box.mg_filtered"),f=d.find(".mg_fpp_pag_wrap"),g=parseInt(f.data("tot-pag"),10),h=I[c];d=d.data("filtered-per-page");if(-1!==a.inArray(b,["next","prev"])){if("next"==b&&h>=g||"prev"==b&&1>=h)return!1;var k="next"==b?h+1:h-1}else if(k=parseInt(b),1>k||k>g||k==h)return!1;I[c]=k;f.find(".mg_fpp_curr_pag").text(k);1==k?f.find(".mg_prev_page").addClass("mg_pag_disabled"):f.find(".mg_prev_page").removeClass("mg_pag_disabled");k==g?f.find(".mg_next_page").addClass("mg_pag_disabled"):
f.find(".mg_next_page").removeClass("mg_pag_disabled");e.addClass("mg_fpp_hidden");f=(k-1)*d;e.slice(f,f+d).removeClass("mg_fpp_hidden");t[c].filter(".mg_filtered:not(.mg_fpp_hidden)");a(window).trigger("mg_resize_grid",[c]);a("html, body").animate({scrollTop:a("#"+c).offset().top-15},300)},F=function(b,c){c=void 0===c?!1:c;if(!a("#"+b).find(".mg_pag_btn_nums, .mg_pag_btn_dots").length)return!1;var d=c?a("#"+b).find(".mg_fpp_pag_wrap"):a("#"+b).find(".mg_pag_wrap:not(.mg_fpp_pag_wrap)"),e=d.find("> div");
d.removeClass("mg_hpb_after mg_hpb_before");e.removeClass("mg_hidden_pb");if(5>=e.length)return!1;var f=0;e.each(function(){f+=a(this).outerWidth(!0)+1});if(f>d.outerWidth()){var g=a("#"+b+" .mg_sel_pag");g=parseInt(g.data("pag"));var h=parseInt(e.last().data("pag")),k=f+(2>=g||g>=h-1?26:52)-d.outerWidth(),l=e.last().outerWidth(!0);l=Math.ceil(k/l);if(2>=g||g>=h-1){k=[];if(2>=g)for(d.addClass("mg_hpb_after"),g=0;g<l;g++)k.push("[data-pag="+(h-g)+"]");else if(g>=h-1)for(d.addClass("mg_hpb_before"),
g=0;g<l;g++)k.push("[data-pag="+(1+g)+"]");e.filter(k.join(",")).addClass("mg_hidden_pb")}else{d.addClass("mg_hpb_before mg_hpb_after");k=["[data-pag="+g+"]"];var m=h-1-l;l=Math.floor(m/2);m=Math.ceil(m/2);var p=g-l,u=g+m;1>=p?(d.removeClass("mg_hpb_before"),m+=-1*p+1):u>=h&&(d.removeClass("mg_hpb_after"),l+=u-(h-1));for(d=1;d<=l;d++)k.push("[data-pag="+(g-d)+"]");for(d=1;d<=m;d++)k.push("[data-pag="+(g+d)+"]");e.not(k.join(",")).addClass("mg_hidden_pb")}}};a(document).ready(function(){a(document).on("click",
".mg_load_more_btn",function(){q=!0;var b=a(this).parents(".mg_grid_wrap").attr("id"),c=a(this).parents(".mg_fpp_pag_wrap").length?!0:!1,d=c?a("#"+b).find(".mg_fpp_pag_wrap"):a("#"+b).find(".mg_pag_wrap:not(.mg_fpp_pag_wrap)"),e=parseInt(d.attr("data-init-pag"),10),f=parseInt(d.attr("data-tot-pag"),10);if(!d.hasClass("mg_fpp_pag_wrap")&&a("#"+b).hasClass("mg_is_filtering")||e>=f)return!1;e+=1;d.attr("data-init-pag",e);if(c){var g=a("#"+b),h=g.find(".mg_box.mg_filtered");g=g.data("filtered-per-page");
g*=e;g=g>h.length?h:h.slice(0,g);h.addClass("mg_fpp_hidden");g.removeClass("mg_fpp_hidden");t[b].filter(".mg_filtered:not(.mg_fpp_hidden)");a(window).trigger("mg_resize_grid",[b])}else{h=[];for(g=1;g<=e;g++)h.push(g);mg_grid_filters[b].mg_pag_={condition:"OR",val:h};mg_exec_filters(b)}e>=f&&d.fadeOut(300,function(){a("#"+b).animate({paddingBottom:0},400);c||d.remove()})});a(window).scroll(function(){var b=a(this).scrollTop();a(".mg_auto_inf_scroll:not(:hidden) .mg_load_more_btn").each(function(){if(a(this).parents(".mg_fpp_pag_wrap").length)return!0;
var c=a(this),d=c.offset().top,e=c.outerHeight(),f=a(window).height();b>d+e-f&&c.trigger("click")})})});a(document).ready(function(){a(document).on("click",".mgf:not(.mgf_selected)",function(b){b.preventDefault();q=!0;b=a(this).parents(".mg_grid_wrap");var c=b.attr("id"),d=b.data("grid-id"),e=a(this).data("filter-id"),f=a(this).text();if(b.hasClass("mg_is_filtering"))return!1;b.find(".mgf").removeClass("mgf_selected");a(this).addClass("mgf_selected");e&&"*"!=e?(mg_grid_filters[c].mgc_={condition:"AND",
val:[e]},mg_set_deeplink("category","mgc_"+d,e,f)):(delete mg_grid_filters[c].mgc_,mg_remove_deeplink("category","mgc_"+d));mg_exec_filters(c);b.find(".mgf_noall_placeh").length&&b.find(".mgf_noall_placeh").remove();return!1})});window.mg_matches_per_filter=function(b){var c=a("#"+b);c.find(".mgf_inner .mgf").length?c.find(".mgf").not(".mgf_all").each(function(){var d=a(this).data("filter-id");d&&a(this).append('<font class="mg_filter_count">'+c.find(".mg_box.mgc_"+d).length+"</font>")}):c.find(".mgaf_sect").length&&
c.find('.mgaf_sect:not([data-type="range"])').each(function(){var d="mg_item_categories"==a(this).data("sect")?".mgc_":"."+a(this).data("sect")+"_";a(this).find(".mgaf_opts_list li").each(function(){var e=a(this).data("val").substr(4);e&&a(this).append('<font class="mg_filter_count">'+c.find(".mg_box"+d+e).length+"</font>")})})};a(document).on("keyup",".mgf_search_form input",function(){"undefined"!=typeof mg_search_defer&&clearTimeout(mg_search_defer);var b=a(this);mg_search_defer=setTimeout(function(){var c=
b.parents(".mg_grid_wrap"),d=c.attr("id"),e=c.data("grid-id"),f=a.trim(b.val());c.find(".mg_box").removeClass("mg_search_res");if(f&&2<f.length){c.find(".mgf_search_form").addClass("mgs_has_txt");var g="any_word"==lcmg.search_behav?f.toLowerCase().split(" "):[f.toLowerCase()],h=[];c.find(".mg_box:not(.mg_spacer)").each(function(){var k=a(this).data("mg-search").toLowerCase(),l=a(this).data("item-id");a.each(g,function(m,p){if(-1!==k.indexOf(p))return h.push(l),!1})});a.each(h,function(k,l){c.find(".mg_box[data-item-id="+
l+"]").addClass("mg_search_res")});mg_grid_filters[d].mg_search_res={condition:"AND",val:[""]};mg_set_deeplink("search","mgs_"+e,f)}else c.find(".mgf_search_form").removeClass("mgs_has_txt"),delete mg_grid_filters[d].mg_search_res,mg_remove_deeplink("search","mgs_"+e);mg_exec_filters(d)},300)});a(document).on("click",".mgf_search_form.mgs_has_txt i",function(){q=!0;var b=a(this).parents(".mg_grid_wrap"),c=b.find(".mgf_search_form input");if(b.hasClass("mg_is_filtering"))return!1;a.trim(c.val())&&
2<c.val().length&&(c.val(""),c.trigger("keyup"))});a(document).on("keypress",".mgf_search_form input",function(b){return 13!=b.keyCode});a(document).on("click",".mgi_txt_under",function(){var b=a(this).parents(".mg_box").find(".mg_box_inner");if(b.is("a")){var c=b.hasAttr("target")?b.attr("target"):"__self";window.open(b.attr("href"),c)}});a(document).ready(function(){a(document).on("click",".mg_inl_video:not(.mgi_iv_shown)",function(b){var c=a(this);q=!0;if(c.find(".mgi_overlays").length&&M&&!c.hasClass("mg_mobile_hovered"))return c.parents(".mg_grid_wrap").find(".mg_box").removeClass("mg_mobile_hovered"),
c.addClass("mg_mobile_hovered"),!1;c.removeClass("mg_mobile_hovered");c.addClass("mgi_iv_shown");c.find(".mg_video_iframe").length?(b=c.find(".mg_video_iframe").data("autoplay-url"),c.find(".mg_video_iframe").attr("src",b).show(),setTimeout(function(){c.find(".mgi_thumb_wrap, .mgi_overlays").fadeTo(350,0,function(){c.parents(".mg_video_iframe").css("z-index",100);a(this).remove()})},50)):c.find(".mgi_thumb_wrap, .mgi_overlays").fadeTo(350,0,function(){a(this).remove();var d="#"+c.find(".mg_sh_inl_video").attr("id");
w[d].play()})});a(document).on("click","#mg_lb_video_poster, #mg_ifp_ol",function(b){q=!0;b=a("#mg_lb_video_poster").data("autoplay-url");"undefined"!=typeof b&&a("#mg_lb_video_wrap").find("iframe").attr("src",b);a("#mg_ifp_ol").fadeOut(120);a("#mg_lb_video_poster").fadeOut(400)})});a(document).ready(function(b){a(document).on("click",".mg_box.mg_inl_audio:not(.mgi_ia_shown)",function(){var c=a(this);q=!0;if(c.find(".mgi_overlays").length&&M&&!c.hasClass("mg_mobile_hovered"))return c.parents(".mg_grid_wrap").find(".mg_box").removeClass("mg_mobile_hovered"),
c.addClass("mg_mobile_hovered"),!1;c.removeClass("mg_mobile_hovered");c.addClass("mgi_ia_shown");if(c.find(".mg_audio_embed").length){var d=c.find(".mg_audio_embed").data("lazy-src");c.find(".mg_audio_embed").attr("src",d).removeData("lazy-src");setTimeout(function(){c.find(".mgi_overlays").fadeTo(350,0,function(){c.find(".mg_audio_embed").css("z-index",100);a(this).remove()})},50)}else d="#"+c.find(".mg_inl_audio_player").attr("id"),la(d,!0),c.find(".mgi_overlays").fadeOut(350,function(){a(this).remove()})})});
var ea=function(){if("undefined"==typeof lcmg.lightbox_mode)return!1;lcmg.lb_touchswipe&&new lc_swiper("#mg_lb_wrap",function(b,c,d){c=a(d);if(c.hasClass("mg_lb_lcms_slider")||c.parents(".mg_lb_lcms_slider").length||c.hasClass("mg_zoomable_img")||c.parents(".mg_zoomable_img").length||c.hasClass("mg_noswipe_el")||c.parents(".mg_noswipe_el").length)return!1;70<b.right?a(".mg_nav_prev > *").trigger("click"):70<b.left&&a(".mg_nav_next > *").trigger("click")});if(a("#mg_deeplinked_lb").length)return r=
a("#mg_lb_contents"),a("html").addClass("mg_lb_shown"),C=!0;a("#mg_lb_wrap").length&&a("#mg_lb_wrap, #mg_lb_background").remove();a("body").append('<div id="mg_lb_wrap"><div id="mg_lb_loader"><div class="mg_loader"><div class="mgl_1"></div><div class="mgl_2"></div><div class="mgl_3"></div><div class="mgl_4"></div></div></div><div id="mg_lb_contents" class="mg_lb_pre_show_next"></div><div id="mg_lb_scroll_helper" class="'+lcmg.lightbox_mode+'"></div></div><div id="mg_lb_background" class="'+lcmg.lightbox_mode+
'"></div>');r=a("#mg_lb_contents")};a(document).ready(function(){a(document).on("click",".mgi_has_lb:not(.mg-muuri-hidden, .mgi_low_opacity_f)",function(b){q=!0;b=a(b.target);if(!(C||b.hasClass("mgom_fb")||b.hasClass("mgom_tw")||b.hasClass("mgom_pt")||b.hasClass("mgom_wa")||b.hasClass("mg_quick_edit_btn")||b.hasClass("mg_custom_behav_btn"))){var c=a(this);if(c.find(".mgi_overlays").length&&M&&!c.hasClass("mg_mobile_hovered"))return c.parents(".mg_grid_wrap").find(".mg_box").removeClass("mg_mobile_hovered"),
...
a("html").css("margin-right",a(window).width()-b)};window.mg_open_item=function(b,c,d){Ca();d?(a("#mg_lb_wrap").addClass("mg_mf_lb"),a("#mg_lb_wrap").attr("mg_mf_lb",1)):(a("#mg_lb_wrap").removeClass("mg_mf_lb"),a("#mg_lb_wrap").removeAttr("mg_mf_lb"));d?a("#mg_lb_wrap").css("display","flex"):a("#mg_lb_wrap").show();1E3>a(window).width()&&r.delay(20).trigger("click");"undefined"!=typeof c&&c||setTimeout(function(){a("#mg_lb_loader, #mg_lb_background").addClass("mg_lb_shown");A(b,d)},50)};var A=function(b,
c,d,e){e=void 0===e?!1:e;var f=$mg_sel_grid.attr("id"),g=$mg_sel_grid.data("grid-id");e||(r.removeClass("mg_lb_shown"),a("#mg_lb_wrap").data("item-id",b).data("grid-id",f),f=a(".mgi_"+b+" .mgi_main_thumb").data("item-title"),mg_set_deeplink("item","mgi_"+g,b,f));var h=[],k=0;$mg_sel_grid.find(".mgi_has_lb").not(".mg-muuri-hidden").each(function(u,G){var x=a(this).data("item-id");h.push(x);x==b&&(k=u)});if(lcmg.lb_carousel)var l=0!==k?h[k-1]:h[h.length-1],m=k!=h.length-1?h[k+1]:h[0];else l=0!==k?h[k-
1]:0,m=k!=h.length-1?h[k+1]:0;var p=""+l+b+m+c;if("undefined"!=typeof R[p]){if(e)return!0;l&&A(l,c,!1,!0);m&&A(m,c,!1,!0);setTimeout(function(){Z(R[p]);c&&qa()},"undefined"==typeof d||d?320:0)}else P=a.post(location.href,{mg_lb:"mg_lb_content",pid:b,prev_id:l,next_id:m,mf_mode:c?1:0},function(u){p&&(R[p]=u);e||(Z(u),l&&A(l,c,!0,!0),m&&A(m,c,!0,!0),c&&qa())}).fail(function(u){u.status&&(console.error(u),Z("Error retrieving contents. Try again please."))});return!0},qa=function(){a(".mg_lb_lb_text").length?
(a("#mg_lb_wrap").removeClass("mg_mf_lb"),a("#mg_lb_wrap").css("display","block")):(a("#mg_lb_wrap").addClass("mg_mf_lb"),a("#mg_lb_wrap").css("display","flex"))},Z=function(b){y||(y="next");r.html(b).attr("class","mg_lb_pre_show_"+y);a(".mg_item_featured .mg_me_player_wrap.mg_self-hosted-video").length&&!a(".mg_item_featured .mg_me_player_wrap.mg_self-hosted-video > img").length&&mg_video_player("#mg_lb_video_wrap");setTimeout(function(){a("#mg_lb_loader").removeClass("mg_lb_shown");r.attr("class",
"mg_lb_shown").focus();a("html").addClass("mg_lb_shown");C=!0;y=!1},50)};a(document).ready(function(){a(document).on("click",".mg_nav_active > *",function(){q=!0;y=a(this).parents(".mg_nav_active").hasClass("mg_nav_next")?"next":"prev";var b=a(this).parents(".mg_nav_active").attr("rel");aa(b)})});a(document).keydown(function(b){if(!C)return!0;if(37==b.keyCode&&a(".mg_nav_prev.mg_nav_active").length){var c=a(".mg_nav_prev.mg_nav_active").attr("rel");y="prev";aa(c)}39==b.keyCode&&a(".mg_nav_next.mg_nav_active").length&&
(c=a(".mg_nav_next.mg_nav_active").attr("rel"),y="next",aa(c))});var aa=function(b){a("#mg_lb_loader").addClass("mg_lb_shown");r.attr("class","mg_lb_switching_"+y);a("#mg_lb_top_nav, .mg_side_nav, .mg_lb_nav_side_basic, #mg_top_close").fadeOut(350,function(){a(this).remove()});var c=a("#mg_lb_wrap")[0].hasAttribute("mg_mf_lb")?!0:!1;setTimeout(function(){ra();r.empty();A(b,c);C=!1},400)},sa=function(){ra();P&&P.abort();B&&clearInterval(B);a("#mg_lb_loader").removeClass("mg_lb_shown");r.attr("class",
...
a("#mg_lb_scroll_helper").removeAttr("style");r.attr("class","mg_lb_pre_show_next");a("html").removeClass("mg_lb_shown");C=!1},500);$mg_sel_grid&&mg_remove_deeplink("item","mgi_"+$mg_sel_grid.data("grid-id"))};a(document).ready(function(){a(document).on("click","#mg_lb_background.mg_classic_lb, #mg_lb_scroll_helper.mg_classic_lb, .mg_close_lb",function(){q=!0;sa()})});a(document).keydown(function(b){a("#mg_lb_contents .mg_close_lb").length&&27==b.keyCode&&sa()});var ra=function(){B&&(clearInterval(B),
...
var d=ca();if("undefined"==typeof d[c])return!1;var e=[];a.each(d,function(f,g){"undefined"!=typeof f&&f&&f!=c&&e.push(g?f+"="+g:f)});d=e.length?"?":"";d=n.slice(0,n.indexOf("?"))+d+e.join("&")+T;history.pushState(null,null,d);-1===n.indexOf("mgi_")&&-1===n.indexOf("mgc_")&&-1===n.indexOf("mgp_")&&-1===n.indexOf("mgs_")&&(L=!1)};window.addEventListener("popstate",function(b){fa();-1===n.indexOf("mgi_")&&-1===n.indexOf("mgc_")&&-1===n.indexOf("mgp_")&&-1===n.indexOf("mgs_")&&(L=!1)});var za=function(b){var c=
...
E[b]=0},O=function(b,c,d){d=S[b];var e=E[b];if("prev"==c)c=e?e-1:d.length-1,d=d[c],E[b]=c;else if("next"==c){if(!a(b+" .mejs-mg-loop-on").length&&a(b+"-tl .mg_current_track").is(":last-child"))return!1;c=e==d.length-1?0:e+1;d=d[c];E[b]=c}else d=d[c-1],E[b]=c-1;c=w[b];c.pause();c.setSrc(d);c.play();a(b+"-tl li").removeClass("mg_current_track");a(b+"-tl li[rel="+(E[b]+1)+"]").addClass("mg_current_track")},la=function(b,c){ba(b,!0);a(b).addClass("mg_inl_audio_shown");a(b+"-tl").length&&a(b+"-tl").show();
setTimeout(function(){ua();"undefined"!=typeof c&&w[b].play()},300)};a(window).on("mg_resize_grid",function(b,c){ua()});a(document).ready(function(b){va()});var va=function(){if("function"!=typeof MediaElementPlayer)return setTimeout(function(){va()},50),!1;MediaElementPlayer.prototype.buildmg_prev=function(b,c,d,e){a('<div class="mejs-button mejs-mg-prev" title="previous track"><button type="button"></button></div>').appendTo(c).click(function(){var f="#"+a("#"+b.id).parent().attr("id");O(f,"prev")})};
...
b.find(".mg_inl_slider_wrap .lcms_wrap").each(function(){lcms_stop(a("#"+a(this).parents(".mg_inl_slider_wrap").attr("id"))[0])})};var ua=function(){a(".mg_inl_audio").not(".mg-muuri-hidden").each(function(){var b=a(this).find(".mg_inl_audio_player").find(".mejs-time, .mejs-time-rail");250<=a(this).find(".mg_media_wrap").width()?b.show():b.hide()})};if(a("body.mg_no_rclick").length)a(document).on("contextmenu",".mg_grid_wrap *, #mg_lb_wrap *, #mg_wp_video_wrap .wp-video *, #mg_lb_contents img, #mg_lb_contents .wp-video *",
function(b){b.preventDefault()});if(lcmg.touch_ol_behav&&M){a("body").addClass("mg_cust_touch_ol_behav");var wa=0;a(document).on("touchstart",".mg_box",function(b){a(this).addClass("mg_ctob_show");wa=(new Date).getTime()}).on("touchend",".mg_box",function(b){a(this).removeClass("mg_ctob_show");a(this).parents(".mg_grid_wrap").trigger("tap");250>(new Date).getTime()-wa&&a(this).hasClass("mgi_has_lb")&&(a(this).find("a.mg_box_inner").length?window.open(a(this).find("a.mg_box_inner").attr("href"),a(this).find("a.mg_box_inner").attr("target")):
...
k+"px");11==h&&14==k&&a(this).addClass("mg_min_reached")}),a("#"+b+" .mg_inl_txt_contents .mg_min_reached").length==c.length)return!1;e++}}}})};a(document).on("click",".mg_link .mgi_txt_under",function(b){q=!0;b.preventDefault();a(this).parents(".mg_box").find("a.mg_box_inner")[0].click()});var Aa=function(b){"WebkitAppearance"in document.documentElement.style&&(a("#mg_wbe_fix_"+b).remove(),setTimeout(function(){a("head").append('<style type="text/css" id="mg_wbe_fix_'+b+'">.mg_'+b+" .mg_box_inner {-webkit-font-smoothing: subpixel-antialiased;}</style>")},
600))}})(jQuery);
